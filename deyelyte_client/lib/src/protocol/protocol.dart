...
import 'inverter_model.dart' as _i10;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i10.InverterModel) {
      return _i10.InverterModel.fromJson(data) as T;
    }
    ...
    if (t == _i16.TierSyncConfig) {
      return _i16.TierSyncConfig.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i10.InverterModel?>()) {
      return (data != null ? _i10.InverterModel.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i16.TierSyncConfig?>()) {
      return (data != null ? _i16.TierSyncConfig.fromJson(data) : null) as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i10.InverterModel => 'InverterModel',
      ...
      _i16.TierSyncConfig => 'TierSyncConfig',
      _ => null,
    };
  }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'InverterModel') {
      return deserialize<_i10.InverterModel>(data['data']);
    }
    ...
    if (dataClassName == 'TierSyncConfig') {
      return deserialize<_i16.TierSyncConfig>(data['data']);
    }
